    ...
    <>
      ...
      <div style={{ boxShadow: '0 0 #0000, 0 0 #0000, 0 1px 2px 0 rgb(0 0 0 / 0.05)' }}
        ...
        <div className="flex flex-col space-y-1.5 pb-6">
          <h2 className="font-semibold text-lg tracking-tight">Rick</h2>
          <p className="text-sm text-[#6b7280] leading-3">FLEX GYM</p>
        </div>
        ...
        <div className="pr-4 h-[474px]" style={{ minWidth: '100%', display: 'table' }}>
          ...
          <div className="flex gap-3 my-4 text-gray-600 text-sm flex-1">
            ...
            <p className="leading-relaxed"><span className="block font-bold text-gray-700">You </span>{userData}</p>
          </div>
        </div>

        {/* Input box */}
        <div className="flex items-center pt-0">
          <form className="flex items-center justify-center w-full space-x-2" onSubmit={e => { e.preventDefault(); callBot(); }}>
            <input
              className="flex h-10 w-full rounded-md border border-[#e5e7eb] px-3 py-2 text-sm placeholder-[#6b7280] focus:outline-none focus:ring-2 focus:ring-[#9ca3af] disabled:cursor-not-allowed disabled:opacity-50 text-[#030712] focus-visible:ring-offset-2"
              placeholder="Type your message" value={userData} onChange={e => setUserData(e.target.value)} />
            <button
